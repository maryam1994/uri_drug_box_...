...
class ConsumptionsControllerTest < ActionController::TestCase
  ...
  test "should create consumption" do
    assert_difference('Consumption.count') do
      post :create, consumption: { prow_id: @consumption.prow_id, start_time: @consumption.start_time, take_status: @consumption.take_status }
    end
  ...
  test "should update consumption" do
    patch :update, id: @consumption, consumption: { prow_id: @consumption.prow_id, start_time: @consumption.start_time, take_status: @consumption.take_status }
    assert_redirected_to consumption_path(assigns(:consumption))
  end
